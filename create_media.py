...
Example: python create_media.py ./media.html ./media.bib ./outputfolder/"
    ...
    for h_span in html_span_elements:
        ...
        selected_entry = bp.statamic_field_media_generator(candidate_by_title)
        today = (time.strftime("%Y-%m-%d"))
        bp.md_media_generator(selected_entry, work_title, output_folder, today + '-' + selected_entry['title'] + '.md')
